...
\end{example}
\begin{property}[Comparaison intégrales / séries]\label{prop:com_integrale_series}
...
\begin{example}
    ...
    \end{align*}
    $I$ converge si et seulement si $p>1$, donc par la propriété \ref{prop:com_integrale_series}
