...
interface Commercial{
    default double affranchirCommercial(double prixAffranchissement, double deduction){
        return prixAffranchissement - (prixAffranchissement * deduction);
    }

    default double affranchirCommercial(double prixAffranchissement){
        return affranchirCommercial(prixAffranchissement, 0.2);
    }
}
...
class LettreCommercial extends Lettre implements Commercial{

    public LettreCommercial(double poids, boolean express, String adresse, String format) {
        super(poids, express, adresse, format);
    }

    @Override
    public double affranchir(){
        return affranchirCommercial(super.affranchir());
    }
...
class ColisCommercial extends Colis implements Commercial{
    ...
    @Override
    public double affranchir(){
        return affranchirCommercial(super.affranchir(), 0.15);
    }
